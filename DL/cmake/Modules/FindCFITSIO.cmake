...
# CFITSIO_INCLUDE_DIR = full path to the header files
...
message("ENV CFITSIO_ROOT = $ENV{CFITSIO_ROOT}")
set(CFITSIO_ROOT $ENV{CFITSIO_ROOT})
message("CFITSIO_ROOT = ${CFITSIO_ROOT}")
...
if(CFITSIO_ROOT)
    ...
    message("CFITSIO_ROOT NOT specified !")
    find_library(CFITSIO_LIBRARY
        NAMES cfitsio
        HINTS /usr /usr/local
        PATHS /usr /usr/local
...
message("CFITSIO_LIBRARY = ${CFITSIO_LIBRARY}")

#set(CFITSIO_LIBRARY "C:/Users/F025566/Main/system/cfit3390/build-src-mingw64builds530sehrt40-Default/libcfitsio.a")
...
if(CFITSIO_FOUND)
  ...
  message(STATUS "found CFITSIO version string ${CFITSIO_VERSION_STRING}")
