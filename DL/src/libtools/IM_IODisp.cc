...
FILE *disp_file_des_in(const char *fname)
{
   FILE *fp;
...
FILE *disp_file_des_out(const char *fname)
{
   FILE *fp;
...
static void read_size_f (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
static void read_size_i (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
static void read_size_b (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
static void read_size_s (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
static void read_size_d (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
static void read_size_cf (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
static void read_size_cd (const char *File_Name, int *nl, int *nc)
{
    int L, Nbr,Ok = 0;
    const char *Ptr;
...
void io_disp::read_type(const char *File_Name)
{
...
void io_disp::read_size  (const char *File_Name)
{
    switch (Type)
    {
...
void io_disp::read_ima  (const char *File_Name)
{
    FILE *File_Des;
...
void io_disp::read_info_ima(const char *File_Name, int &Nl, int &Nc,
                            type_data & TypeDat)
{
...
void io_disp::read_block_ima(const char *File_Name,Ifloat & Image,int Indi, int Indj)
{
    FILE *File_Des;
    unsigned char *Buff;
...
void io_disp::read_block_ima(const char *File_Name,Iint & Image,int Indi, int Indj)
{
    FILE *File_Des;
    unsigned char *Buff;
    unsigned char *buffer;
...
void io_disp::write_block_ima(const char *File_Name,Ifloat & Image,int Indi, int Indj)
{
    FILE *File_Des;
...
void io_disp::write_block_ima(const char *File_Name, Iint & Image,int Indi, int Indj)
{
    FILE *File_Des;
    unsigned char *Buff=NULL;
    unsigned char *buffer;
...
void io_disp::create_file  (const char *File_Step_Name)
{
     FILE *File_Des;
...
void io_disp::write_ima  (const char *File_Step_Name)
{
    FILE *File_Des;
    char File_Name[MAXCHAR];
...
void io_disp::read_ima_int (const char *File_Name, Iint & Image)
{
    int i,j;
...
void io_disp::read_ima_float (const char *File_Name, Ifloat & Image)
{
    int i,j;
    read_type(File_Name);
...
void io_disp::read_ima_complex_f (const char *File_Name, Icomplex_f & Image)
{
    int i,j;
    read_type(File_Name);
...
void io_disp::write_ima_int (const char *File_Name, Iint & Image)
{
    Type = T_INT;
...
void io_disp::write_ima_float (const char *File_Name, Ifloat & Image)
{
    Type = T_FLOAT;
    Nl_io = Image.nl();
    Nc_io = Image.nc();    
...
void io_disp::write_ima_complex_f (const char *File_Name, Icomplex_f & Image)
{
    Type = T_COMPLEX_F;
    Nl_io = Image.nl();
    Nc_io = Image.nc();    
