...
*******************************************************************************
**
** void io_read_ima_int  (const char *File_Name, Iint &)
** 
** read int image from file
**
*******************************************************************************
**
** void io_write_ima_int (const char *, Iint &)
**
** write int image to file
**
*******************************************************************************
**
** void io_read_ima_float  (const char *, Ifloat &)
**
** read float image from file
**
*******************************************************************************
**
** void io_write_ima_float (const char *, Ifloat &)
**
...
void io_read_ima_int  (const char *File_Name, Iint &Image, fitsstruct *Header, Bool NoBscale)
{
    fitsstruct HD,*PtrHD;
...
void io_write_ima_int  (const char *File_Name, Iint &Image, fitsstruct *Header)
{
     fitsstruct HD;
...
void io_read_ima_float (const char *File_Name, Ifloat &Image, fitsstruct *Header)
{
    fitsstruct HD,*PtrHD;
...
void io_write_ima_float  (const char *File_Name, Ifloat &Image, fitsstruct *Header, Bool NormData)
{
    fitsstruct HD;
...
static void  read_datacomplex_f (const char *File_Step_Name, Icomplex_f & Image)
{
    int i,j;
    char File_Name[100];
...
void io_read_ima_complex_f  (const char *File_Name, Icomplex_f &Image)
{
    if (Format_Imag == F_UNKNOWN)
                     Format_Imag = io_detect_format (File_Name);
    switch (Format_Imag)
...
void io_write_ima_complex_f  (const char *File_Name, Icomplex_f &Image)
{
