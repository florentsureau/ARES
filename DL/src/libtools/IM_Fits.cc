...
void fits_read_block(const char *filename, Ifloat & Image, int Indi, int Indj, Bool NoBscale)
{
    // for fits
...
void fits_read_block(const char *filename, Iint & Image, int Indi, int Indj, Bool NoBscale)
{
    // for fits
    fitsfile *fptr;           /* pointer to the FITS file */
    int status=0, hdutype ;
...
void fits_read_int(const char *File_Name, Iint & Image, fitsstruct *Header, Bool NoBscale)
{
    int Nl, Nc;
