    ...
    **Keyword parameters**
    ...
    def _calculate_subsampled_spectrograms(self, verbose):
        ...
        for (j, k, cone), coord in my_tqdm(zip(self._indices[1:],
            ...
            # FIXME : Evaluation of the scale_fct could be optimized
    ...
    def _transform_fourier(self, im_fourier):
        ...
        if self.is_subsampled:
            ...
            # FIXME: Originally, this returned a list, not a numpy.array!
    ...
    def adjoint_transform(self, coeffs, spectrograms=None, do_norm=True):
        ...
        **Return value**
        ...
        # FIXME : Maybe there is a more reliable way
    ...
    # FIXME: Add a method for calculating the 'space-side' shearlets!
    ...
    def inverse_transform(self,
        ...
        if self.is_parseval:
            ...
            # FIXME: Do we really always want 'complex128'?
            result = np.zeros((self.height, self.width), dtype='complex128')
